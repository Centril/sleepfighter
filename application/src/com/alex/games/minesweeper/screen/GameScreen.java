...
public class GameScreen implements Screen {
	...
	public GameScreen(Game game) {
		...
		float minDim = Math.min( w, h ) - 10;
		CellSize = (int) ( minDim / Math.max( cellHeight, cellWidth ) );
		if ( CellSize * (cellHeight + 3) > h - 10 ) {
			CellSize = (int) (minDim / (cellHeight + 3));
		}
		...
		TextureAtlas atlas = new TextureAtlas(Gdx.files.internal("minesweeper/textures/pack"), 
											  Gdx.files.internal("minesweeper/textures/"));
		...
		font = new BitmapFont(Gdx.files.internal("minesweeper/font16.fnt"), 
							  Gdx.files.internal("minesweeper/font16.png"), false);
	...
	private void loadExplosion() {
		TextureAtlas atlas = new TextureAtlas(Gdx.files.internal("minesweeper/explosionMap"), Gdx.files.internal("minesweeper/"));
