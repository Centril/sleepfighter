...
public class SecondTimePicker extends FrameLayout {
	...
	private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
		public void onTimeChanged( SecondTimePicker view, int hourOfDay, int minute, int seconds ) {
		}
	};
	...
	public interface OnTimeChangedListener {
		 ...
		 */
		void onTimeChanged( SecondTimePicker view, int hourOfDay, int minute,
				int seconds );
	}
	...
	public SecondTimePicker( Context context, AttributeSet attrs ) {
		this( context, attrs, 0 );
	}

    public SecondTimePicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        LayoutInflater inflater =
                (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.second_time_picker_widget,
